...
## DONE: Create Blog Post HTML structure and styling
...
## DONE: Complete the post.html page
...
## DONE API (Together): Set Up a NodeJS Server

## DONE API: Create an API Endpoint to return list of posts
...
## DONE API (Together): Create post.js for interacting with data.json

## DONE API: Create readData function to get data from data.json

## DONE API(Together): Create storeData function to store data into data.json together with add() function

## DONE API : Create an API Endpoint to return one post based on id
`Endpoint: /api/posts/:post_id Method: GET`

### HINT: Use post.js for getting data from data.json 

## DONE(Together): Complete index.js to connect to API and get list of posts
### HINT Make sure to make the statis files public

## DONE: Complete post.js to get data from API and fill in the post.html
